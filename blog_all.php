<?php
/**
 * Страница всех статей блога с пагинацией - русская версия
 * Baumaster Frontend - All Blog Posts Page (Russian)
 */
...
$seo['title'] = 'Все статьи - ' . $seo['title'];
...
$blog_posts = get_blog_posts_paginated($posts_per_page, $offset, 'ru');
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="text-center">
            ...
            <p class="text-xl text-text-secondary max-w-4xl mx-auto">
                Все статьи и новости о ремонте, новых материалах и технологиях
            </p>
        </div>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            <p class="text-lg text-text-secondary">
                Показано <?php echo count($blog_posts); ?> из <?php echo $total_posts; ?> статей
            </p>
        </div>
                ...
                <nav class="flex items-center space-x-2" aria-label="Pagination">
                    ...
                    <?php for ($i = $start_page; $i <= $end_page; $i++): ?>
                        <?php if ($i == $current_page): ?>
                            <span
                                class="px-3 py-2 text-sm font-medium text-white bg-accent-blue border border-accent-blue rounded-md">
                                <?php echo $i; ?>
                            </span>
                        <?php else: ?>
