...
function render_frontend_head($title = '', $meta_description = '', $active_page = '') {
    ...
    <style>
        ...
        .hero-title-animation {
            animation: heroTitleSlideUp 1.2s ease-out 0.5s both;
        }
        
        .hero-subtitle-animation {
            animation: heroSubtitleSlideUp 1s ease-out 1s both;
        }
        
        .hero-button-animation-1 {
            animation: heroButtonSlideUp 0.8s ease-out 1.5s both;
        }
        
        .hero-button-animation-2 {
            animation: heroButtonSlideUp 0.8s ease-out 1.7s both;
        }
