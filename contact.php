...
/* Breathing animation for quick contact buttons */
@keyframes breathe {
    0%, 100% {
        transform: scale(1);
...
<section class="py-8 bg-white">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div class="text-center contact-info-block" onclick="window.open('tel:<?php echo str_replace([' ', '(', ')', '-'], '', $contact_info['phone']); ?>', '_self')">
            ...
            <div class="text-center contact-info-block" onclick="window.open('mailto:<?php echo $contact_info['email']; ?>', '_self')">
                <div class="w-12 h-12 bg-accent-blue text-white rounded-full flex items-center justify-center mx-auto mb-3">
                    <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        <?php render_frontend_button([
                            ...
                            'variant' => 'secondary',
                            'size' => 'lg',
                            'class' => 'w-full justify-start quick-contact-btn',
