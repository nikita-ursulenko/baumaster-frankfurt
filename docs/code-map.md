...
### Функции миграции и развертывания

| Имя                         | Тип      | Модуль/Класс                       | Назначение                 | Пример использования                   |
| --------------------------- | -------- | ---------------------------------- | -------------------------- | -------------------------------------- |
| `create_backup()`           | function | scripts/create_backup.sh           | Создание полного бэкапа    | `./scripts/create_backup.sh`           |
| `optimize_for_production()` | function | scripts/optimize_for_production.sh | Оптимизация для production | `./scripts/optimize_for_production.sh` |

### Константы для production

| Имя          | Тип    | Модуль/Класс | Назначение                     | Пример использования                                |
| ------------ | ------ | ------------ | ------------------------------ | --------------------------------------------------- |
| `SITE_URL`   | string | config.php   | URL сайта для production       | `define('SITE_URL', 'https://baumeister.page.gd');` |
| `DEBUG_MODE` | bool   | config.php   | Режим отладки (false для prod) | `define('DEBUG_MODE', false);`                      |
...
- **2025-09-25**: Добавлены функции миграции и production константы
